...
if not depsonly:
    print("Device %s not found. Attempting to retrieve device repository from BlissRoms-Devices (http://github.com/BlissRoms-Devices)." % device)
...
def add_to_manifest(repositories, fallback_branch = None):
    ...
    for repository in repositories:
        ...
        if is_in_manifest(repo_target):
            print('BlissRoms-Devices/%s already fetched to %s' % (repo_name, repo_target))
            continue

        print('Adding dependency: BlissRoms-Devices/%s -> %s' % (repo_name, repo_target))
