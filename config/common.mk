...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(BLISS_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml rild Calendar android.hidl.memory@1.0-impl.vendor vndk_apex_snapshot_package)
endif
